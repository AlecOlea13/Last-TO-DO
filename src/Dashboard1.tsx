...
const STATUS_CONFIG: Record<Status, { label: string; color: string; bg: string }> = {
  Pendiente:    { label: "Con el cliente",   color: "#f59e0b", bg: "rgba(245,158,11,0.12)"  },
  "En Progreso":{ label: "En taller", color: "#3b82f6", bg: "rgba(59,130,246,0.12)"  },
  Completada:   { label: "Exhibiciòn",  color: "#22c55e", bg: "rgba(34,197,94,0.12)"   },
};
